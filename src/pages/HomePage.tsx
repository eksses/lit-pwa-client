...
import { Search, Sparkles, RefreshCw, TrendingUp, Flame } from 'lucide-react';
  ...
  return (
    <div className="space-y-4 pb-20 max-w-xl mx-auto">
      ...
      <div className="space-y-2 pt-1">
        ...
        <div className="flex items-center space-x-1.5 overflow-x-auto no-scrollbar text-xs font-bnUI pt-1">
          {categories.map((cat) => {
