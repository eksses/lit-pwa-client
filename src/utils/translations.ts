...
export const translations = {
  ...
  prosePoetry: { bn: 'গদ্যকবিতা', en: 'Prose Poetry' },
  novel: { bn: 'উপন্যাস', en: 'Novel' },
  serialStory: { bn: 'ধারাবাহিক গল্প', en: 'Serial Story' },
  longStory: { bn: 'দীর্ঘ গল্প', en: 'Long Story' },
  collection: { bn: 'সংকলন', en: 'Collection' },
  philosophy: { bn: 'দর্শন', en: 'Philosophy' },
  uncategorized: { bn: 'সাধারণ / অন্যান্য', en: 'General / Other' },
  ...
  categoryProseDesc: { bn: 'গদ্যের অবয়বে ছন্দের গভীর কবিতাংশ', en: 'Poetic expression structured in rhythmic prose' },
  categoryPhilosophyDesc: { bn: 'দর্শন চিন্তা, অস্তিত্ববাদ ও তত্ত্বকথা', en: 'Philosophical thoughts, existentialism & theory' },
  categoryUncategorizedDesc: { bn: 'বিবিধ সাহিত্যচিন্তা ও সাধারণ রচনা', en: 'Miscellaneous literary thoughts and general writing' },
